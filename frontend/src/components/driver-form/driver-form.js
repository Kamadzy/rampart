...
class DriverForm extends Component {
    ...
    generatePdf() {
        ...
        if (backgroundImages.length === 0) {
            throw new Error(
                'Failed to build PDF document, background images are missing.'
            );
        }
        ...
        doc.setFontSize(9.5);
        let accidentNature1 = doc.splitTextToSize(
            this.state.accidentNature1,
            41
        );
        ...
        doc.setFontSize(9.5);
        let accidentNature2 = doc.splitTextToSize(
            this.state.accidentNature2,
            41
        );
        ...
        doc.setFontSize(9.5);
        let accidentNature3 = doc.splitTextToSize(
            this.state.accidentNature3,
            41
        );
    ...
    async setBackgroundImages() {
        ...
        const requests = imageUrls.map(async (src) =>
            ...
            <div className='container'>
                <div className='page1-content'>
                    <div className='headline'>
                        <h2>
                            Application for independent driver or owner operator
                        </h2>
                        <p>
                            In compliance with Federal and state equal
                            employment opportunity laws, qualified applicants
                            are considered for all positions without regard{' '}
                            <br /> to rase, region, sex, national origin, age,
                            marital status, or non-job related medical condition
                            or handicap - Equal Opportunity Contractor.{' '}
                        </p>
                    </div>
                    ...
                    <div className='table-headline'>
                        ...
                        <div className='row table-headline-checkbox'>
                            <p>
                                If don't have any experience in the operation of
                                motor vehicles please, check here:
                            </p>
                            <Checkbox
                                name='expCheck'
                                onChange={(e, state) =>
                                    this.onChecked(e, state)
                                }
                                color='primary'
                    ...
                    <div className='main-table'>
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th scope='col'>
                                        ...
                                        <span>
                                            (VAN, REEFER, TANK, FLAT. ECT.)
                                        </span>
                                    </th>
                                    <th scope='col' colSpan='2'>
                                        DATES <br />{' '}
                                        <span className='spanDate1'>FROM</span>{' '}
                        ...
                        <div className='accident-table-headline'>
                            ...
                            <div className='row'>
                                <p>
                                    Please list all motor vehicle accidents in
                                    which you were involved for the past 3
                                    years, listing the most recent accident
                                    first. If none, check here:
                                </p>
                                <Checkbox
                                    name='accCheck'
                                    onChange={(e, state) =>
                ...
                <div className='page2-content'>
                    ...
                    <div className='row headline-violations'>
                        <p>
                            Please list all motor vehicle violations of which
                            you were convicted or forfeited bond or collateral
                            during the past 3 years. If none, check here:
                        </p>
                        <Checkbox
                            name='violCheck'
                    ...
                    <div className='license-questions'>
                        ...
                        <h5>
                            IF THE ANSWER TO THE ABOVE QUESTIONS IS YES, ATTACH
                            A STATEMENT GIVING DETAILS.
                        </h5>
                    </div>
                    <div className='epmloyment-headline'>
                        <h5>PREVIOUS EMPLOYMENT RECORD</h5>
                        <p>
                            Dot Requires That Employment for at Least 3 Years
                            and/or Commercial Driving Experience for the Past 10
                            Years Be Shown <br /> Please list the most recent
                            employers first.
                        </p>
                    </div>
                    ...
                    <div className='page2-sign'>
                        ...
                        <p className='page2-sign-p'>
                            ...
                            knowledge. I authorize you to <br />
                            make such investigations and Inquiries of my
                            personal, employment, financial or medical history
                            and other related matters as may be necessary in
                            arriving at an employment <br /> decision.
                            ...
                            employers from <br />
                            all liability In responding to Inquiries and
                            releasing infomnaUon In connection with my
                ...
                <div className='page3-content'>
                    ...
                    <div className='row alcoDrug-ques1'>
                        <p>
                            Has the driver participated in the RANDOM controlled
                            substances testing program for the previous 12
                            months?
                        </p>
                        <FormControlLabel
                            label='Yes'
                    ...
                    <p className='alcoDrug-semiText'>
                        Plaese provide all of the documentation from the
                        driver's past alcohol and drug testing results <br />{' '}
                        and documentation of participation in another/any drug
                        testing program.
                    </p>

                    <div className='row alcoDrug-ques2'>
                        <p>
                            Has the above named driver had an alcoholic test
                            with a result of 0.04 alcohol concentration or
                            greater?
                        </p>
                        <FormControlLabel
                            label='Yes'
                    ...
                    <div className='row alcoDrug-ques3'>
                        <p>
                            Has the above named driver verified positive for
                    ...
                    <div className='row alcoDrug-ques4'>
                        <p>
                            Has the above named driver refused a request test
                            for alcohol or drugs during the past 12 months?
                        </p>
                        <FormControlLabel
                            label='Yes'
                            control={
                ...
                <div className='page7-content'>
                    <h5 className='sertOfViolHeadline'>
                        Certification of violations
                    </h5>
                    <div className='row sertOfViol'>
                        <p>
                            If you have not been convicted of forfeited bond or
                            collateral on account of any violations, please
                            check here:
                        </p>
                        <FormControlLabel
                            control={
                        ...
                        <table className='table table-bordered'>
                            <thead>
                                <tr>
                                    <th
                                        scope='col'
                                        className='sertOfViolTableTh1'
                                    >
                                        DATE
                                    </th>
                                    <th
                                        scope='col'
                                        className='sertOfViolTableTh'
                                    >
                                        OFFENSE
                                    </th>
                                    <th
                                ...
                                <tr>
                                    <td>
                                        <MaskedInput
                                            ...
                                            guide={true}
                                            value={
                                                this.state.sertOfViolTableDate1
                                            }
                                    ...
                                    <td>
                                        <InputBase
                                            ...
                                            value={
                                                this.state.sertOfViolTableLoc1
                                            }
                                            onChange={this.onChange}
                                            fullWidth={true}
                                        />
                                ...
                                <tr>
                                    <td>
                                        <MaskedInput
                                            ...
                                            guide={true}
                                            value={
                                                this.state.sertOfViolTableDate2
                                            }
                                    ...
                                    <td>
                                        <InputBase
                                            ...
                                            value={
                                                this.state.sertOfViolTableLoc2
                                            }
                                            onChange={this.onChange}
                                            fullWidth={true}
                                        />
                                ...
                                <tr>
                                    <td>
                                        <MaskedInput
                                            ...
                                            guide={true}
                                            value={
                                                this.state.sertOfViolTableDate3
                                            }
                                    ...
                                    <td>
                                        <InputBase
                                            ...
                                            value={
                                                this.state.sertOfViolTableLoc3
                                            }
                                            onChange={this.onChange}
                                            fullWidth={true}
                                        />
                                ...
                                <tr>
                                    <td>
                                        <MaskedInput
                                            ...
                                            guide={true}
                                            value={
                                                this.state.sertOfViolTableDate4
                                            }
                                    ...
                                    <td>
                                        <InputBase
                                            ...
                                            value={
                                                this.state.sertOfViolTableLoc4
                                            }
                                            onChange={this.onChange}
                                            fullWidth={true}
                                        />
                                ...
                                <tr>
                                    <td>
                                        <MaskedInput
                                            ...
                                            guide={true}
                                            value={
                                                this.state.sertOfViolTableDate5
                                            }
                                    ...
                                    <td>
                                        <InputBase
                                            ...
                                            value={
                                                this.state.sertOfViolTableLoc5
                                            }
                                            onChange={this.onChange}
                                            fullWidth={true}
                                        />
                ...
                <div className='cargoTrainingAcknow'>
                    <div className='cargoTrainingHeadline'>
                        ...
                        <p>
                            I have been trained and instructed on the
                            regulations for inspection, tying down and securing
                            cargo that went into effect January 1, 2004. <br />{' '}
                ...
                <div className='cdl-regul'>
                    <div className='cdl-regul-headline'>
                        <h5>
                            Driver's Certificate of training on the cdl
                            regulations
                        </h5>
                        <p>
                            The Commercial Driver's License, regulations define
                            offenses that if committed can cause a driver's
                            license to be suspended, revoked, canceled or cause
                            the driver to be disqualified from operating a
                            commercial motor vehicle.
                        </p>
                        <p>
                            I have been trained and instructed on the DOT
                            regulations and penalties that I am subject to if
                            convicted of any of the following offenses while
                            operating a commercial or non-commercial motor
                            vehicle.
                        </p>
                    </div>
